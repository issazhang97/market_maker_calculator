...
import { downloadPivotExcel } from "../services/pivotExporter";

interface Props {
  data: GenericPivotData | null;
}

export function PivotExportButton({ data }: Props) {
